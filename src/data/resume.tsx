...
export const DATA = {
  ...
  academicProjects: [
    ...
    {
      title: "Automated Rapid Cooling of High Temperature Vacuum Furnaces for High Throughput Neutron Experimentation",
      slug: "automated-rapid-cooling-neutron-vacuum-furnaces",
      category: "phd",
      href: "#",
      dates: "2026",
      active: true,
      description: "Presents an automated rapid-cooling approach for high-temperature vacuum furnaces used in neutron experimentation, shortening the time between experiments while preserving a controlled, repeatable sample environment.",
